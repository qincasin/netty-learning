...
final class PoolSubpage<T> implements PoolSubpageMetric {
    ...
    long allocate() {
        ...
        // 代入法： bitmapIdx is 68   => q = 1,    bitmapIdx is 16  => q = 0 ;  除以 64
        //bitmap[q]
        int q = bitmapIdx >>> 6;
        ...
        // bitmap[1] = 0b 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 1111  原来的值
        //             0b 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0001 0000  上面 1L << 4 之后的值
        // bitmap[1] = 0b 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0001 1111  进行或运算
        bitmap[q] |= 1L << r;
    ...
    private long toHandle(int bitmapIdx) {
        ...
        // 假设 bitmapIdx = 68
        // (long) bitmapIdx << 32
        // 68 => 0b 0100 0100 => 0b 0000 0000 0000 0000 0000 0000 0100 0100 0000 0000 0000 0000 0000 0000 0000 0000 高32位 和低32位

        // memoryMapIdx 是什么？ 当前subpage占用chunk的叶子节点 ID 值。 左边的值
